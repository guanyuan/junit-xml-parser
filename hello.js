...
var suites = [
  {
    ...
    "testCases": [{
      ...
      "messages": {"values": [], "id": "messages_DHZHY"},
      "type": "passed",
      "id": "test_gsC8a",
      "time": "0.001"
    }],
    "properties": {"values": [], "id": "properties_TJnvy"},
  ...
  },
  {
    ...
    "testCases": [{
      ...
      "name": "Use a program name that matches the source file name",
      "messages": {"values": [], "id": "messages_r06UP"},
      "type": "passed",
      "id": "test_B5A4b",
      "time": "0.001"
    }],
    "properties": {"values": [], "id": "properties_3glyi"},
    "contracted": "contracted"
  }]
